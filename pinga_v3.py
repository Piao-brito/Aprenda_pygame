...
def novaBola():
    ...
    tipo = random.choice(["morcego","olho","fantasma"])
    tamanho = random.randint(1, 5) # Tamanho aleatório
...
for index in range(1,5):
    imagem = pygame.image.load(f"assets/fantasma/ghost{index}.png")
    imagem = pygame.transform.scale(imagem,(30,30)).convert_alpha()
    listaimagesfantasma.append(imagem)

for index in range(1,6):
    imagem = pygame.image.load(f"assets/morcego/bat{index}.png")
    imagem = pygame.transform.scale(imagem,(30,30)).convert_alpha()
    listaimagesmorcego.append(imagem)

for index in range(1,5):
    imagem = pygame.image.load(f"assets/olho/fly-eye{index}.png")
    imagem = pygame.transform.scale(imagem,(30,30)).convert_alpha()
    listaimagensolho.append(imagem)

for index in range(1,5):
     imagem = pygame.image.load(f"assets/fogo/fireball{index}.png")
     imagem = pygame.transform.scale(imagem,(30,30)).convert_alpha()
     listaimagesfogo.append(imagem)
...
while True:
    ...
    tela.blit(listaplanofundo[6],(0,0))
    tela.blit(listaplanofundo[7],(0,0))
    tela.blit(listaplanofundo[8],(0,0))
    ...
    if not jogoAcabou:
        ...
        for bola in listaBolas:
            ...
            listaimagens =[]
            if bola["tipo"] =="fantasma " :listaimagens =  listaimagesfantasma
            elif bola["tipo"] =="morcego" :listaimagens =  listaimagesmorcego
            elif bola["tipo"] =="olho " :listaimagens =  listaimagensolho
            elif bola["tipo"] =="fogo " :listaimagens =  listaimagesfogo
